document.addEventListener('DOMContentLoaded', event => {
    ...
    /*document.getElementById("btn_move").addEventListener("click", () => {
        call_delante_service("delante")
    })*/
    document.getElementById("btn_stop").addEventListener("click", stop)
    document.getElementById("btn_right").addEventListener("click", right)
    document.getElementById("btn_left").addEventListener("click", left)
    ...
    data = {
        // ros connection
        ros: null,
        rosbridge_address: direccionBridge.value,
        connected: false,
        // service information 
	    service_busy: false, 
	    service_response: ''
    ...
    function call_delante_service(valor){
      ...
      //definimos los datos del servicio
        let service = new ROSLIB.Service({
            ros: data.ros,
            name: '/movement',
            serviceType: 'custom_interface/srv/MyMoveMsg,srv'
        })
